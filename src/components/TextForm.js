...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            ...
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={buttonClick}>Convert to TitleCase</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={speak} type="submit">Speak</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleReverse}>Reverse Text</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleSentenceCaseClick}>SentenceCaseClick</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={downloadTxtFile}>Download Text</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={base64Encode}>Cvt to base64Encode</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={base64Decode}>Cvt to base64Decode</button>
